...
import 'package:movieapp/model/movie/movie_details_model.dart';
...
// trả về reviews
  ...
  // trả về phim trên tv
  static Future<TVModel> getSimilarTV(int id) async {
    var params = {"api_key": apiKey, "language": "en-us"};
    try {
      Response response =
...
// khám phá phim
  ...
  //xem phim vs cac tính năng khác như phát sóng hôm nay, top , yêu thích,..
  //
