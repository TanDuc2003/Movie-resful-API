...
class SimilarTVs extends StatefulWidget {
  ...
  final int id;
  @override
  State<SimilarTVs> createState() => _SimilarTVState();
}

class _SimilarTVState extends State<SimilarTVs> {
  @override
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        FutureBuilder<TVModel>(
          ...
          //gắn keywword
          future: HttpRequest.getSimilarTV(widget.id), // nhớ nhập đúng keyword
          builder: (context, AsyncSnapshot<TVModel> snapshot) {
            if (snapshot.hasData) {
              ...
              return _buildSimilarTVWidget(snapshot.data!);
...
//màn hình lỗi
  ...
  Widget _buildSimilarTVWidget(TVModel data) {
